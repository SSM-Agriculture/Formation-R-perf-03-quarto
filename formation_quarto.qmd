...
Un paquet {quarto} et un binaire `quarto`.
...
::: notes
- Le programme est livré avec RStudio (mais peut être intallé à part aussi)
- La paquet n'est pas indispensable mais peut être utile
- Typst n'est pas encore disponible sur CERISE pour générer du PDF sans LaTeX
:::

# Structure et syntaxe

::: notes
On passe en revue rapidement les élément d'un document Quarto, puis on revient dessus dans le détail par la suite
:::
